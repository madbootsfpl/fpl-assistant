...
Current Sprint: Sprint 035 - Phase 4: grounding verification (✅ Complete, 3/3 stories, retro done)
...
Tests: 312 · ADRs: 37 · CI: GitHub Actions (ruff + pytest on push, Py 3.13/3.14) · Phase 4: grounded `ask` (verified — a ✓/⚠ trust line, ADR-037) + multi-transfer plans with per-GW columns
