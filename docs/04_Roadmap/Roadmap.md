...
| **Cold-start xMins forced to 1.0** (ADR-172) | **GW4-6 — held by decision 2026-09-01**, not blocked | ⚠️ **new, measured 2026-09-01.** A no-history player is modelled as a nailed 90-minute starter: **Mendy projects on 60 minutes a game, Yalcouyé on 38.** ADR-172 fixed the *rate* half of this pair; this is the *minutes* half, stacked on top, and it wants its own gate because fixing both at once would leave neither measurable |
