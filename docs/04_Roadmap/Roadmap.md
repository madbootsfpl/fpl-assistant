...
| Re-measure the 6 single-GW constants | ~~GW4-6~~ **unblocked 2026-09-13** | exodus p10 · ownership floor · captain-margin + concentration quartiles. Ship the new value if it moves ≥20%. **These gate whether a message appears at all**, so a quartile measured on one gameweek is a feature that fires on everyone or no one. Same sitting, same data, cheaper than the sweeps. |
