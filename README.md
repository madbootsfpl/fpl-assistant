...
**89 ADRs · 705 tests · CI green.** New here? See the **[Product overview](docs/00_Project/PRODUCT.md)**
...
- **Ask** — a grounded, **conversational** chat (follow-ups + pronouns: *"why?"*, *"compare him to …"*) with
  its ✓/⚠ trust line; captain · transfer · squad-build · chip answers show **explainability** — a
  **Confidence · Why (✓) · Risk (⚠)** block, every reason computed from the data (ADR-089); it also explains **FPL rules** from a curated KB
