...
with st.expander("2 · Make it yours  →  **Squads → My Squad**", expanded=True):
    st.markdown(
        ...
        "**rename**, **swap** any player for a new one (a *transfer* — legality-checked; filter by **position**, "
        "tick **Affordable only** to hide replacements over your **bank**), or set the whole **bench** at once "
        "(pick 4). If cross-device is enabled, **☁ Save/Load "
